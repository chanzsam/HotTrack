<template>
  <div class="page-container">
    <div class="page-header">
      <h1 class="page-title">🚀 爆红追踪</h1>
      <p class="page-subtitle">追踪爆红速度最快的视频，发现下一个爆款</p>
    </div>
    ...
    <div class="filter-bar">
      ...
      <select v-model="hours">
        <option value="168">7 天内</option>
        <option value="360">15 天内</option>
        <option value="720">30 天内</option>
      </select>
        ...
        <table class="video-table">
          ...
          <tbody>
            <tr v-for="v in videos" :key="v.id">
              ...
              <td>
                <span class="viral-score" :class="getViralClass(v.viral_score)">{{ v.viral_score?.toFixed(1) }}</span>
              </td>
              <td class="data-value">{{ formatNumber(v.viral_speed) }}/h</td>
